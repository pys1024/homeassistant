...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    switches = [AliuSwitch(friendly_name, addr, id, timeout)]
    if Aliu0_protocol.datalink is None:
        Aliu0_protocol.datalink = Aliu0_protocol(NRF_BUS, NRF_CE, NRF_IRQ, HOST_ADDR, SLAVE_BASE)
